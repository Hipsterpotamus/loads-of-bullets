        ...
        this.show = function () {
            switch (this.render) {
                ...
                case "FourCircle":
                    ...
                    ellipse((this.pos.x - this.r) * P, this.pos.y * P, this.bullet.r * 2 * P, this.bullet.r * 2 * P);
                    ellipse((this.pos.x + this.r) * P, this.pos.y * P, this.bullet.r * 2 * P, this.bullet.r * 2 * P);
                    ellipse(this.pos.x * P, (this.pos.y - this.r) * P, this.bullet.r * 2 * P, this.bullet.r * 2 * P);
                    ellipse(this.pos.x * P, (this.pos.y + this.r) * P, this.bullet.r * 2 * P, this.bullet.r * 2 * P);
                    break;
                case "CircleV":
                    push();
...
function inScreen(x, y, r) {
    if ((x + r) * P > 1920 || (x - r) * P < 0 || (y + r) * P > 1100 * P || (y - r) * P < 0) {
        return false;
    }
    return true;
}